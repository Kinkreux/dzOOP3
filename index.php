        ...
        <h1>Мое домашнее задание по лекции 3.3 "Пространства имен, перегрузка и встроенные интерфейсы и классы"</h1>
            <h2>1. Мое понимание пространства имен</h2>
                ...
                <ul>
                    ...
                    <li>Как и в файловой системе, если мы зашли в папку, то пока мы оттуда не вышли, все файлы в папке и внутри нее нам доступны. В файловой системе, конечно, это организовано гибче, но там другие пользовательские цели. Хотя механизм "домашней папки" в тех же Линуксах и механизм определения пространства имен в процедурном файле крайне похожи.</li>
                </ul>
                <p>Соблюдение стандартов по именованию физических папок и пространств имен позволяет среди прочего написать один универсальный автозагрузчик, что правильно и профессионально. Кода в таком загрузчике мало, его работа до предела прозрачна: берем пространство имен, к которому обращаемся, заменяем слэши пространства имен на DIRECTORY_SEPARATOR, добавляем в начале путь до физического корня сервера, получаем абсолютный путь для загрузки файла класса, который работает независимо ни от чего, кроме соблюдения стандартов.</p>
            ...
            <h2>2. Мое понимание исключений (Exception) и зачем они нужны</h2>
                ...
                <ol>
                    ...
                    <li>Ловить и обрабатывать ошибки, включая фатальные, не пугая пользователя, а используя определенный "план B";</li>
                </ol>
            ...
            <h2>3. Код Товара, Корзины и Заказа</h2>
                <a href="https://github.com/Kinkreux/dzOOP3" target="_blank">Открыть в новом окне репозиторий на Github</a>
                <p><small>Я не стала писать процедурный файл с демонстрацией, потому что этого не было в задании. Пространство имен видно по файловой структуре на GitHub.</small></p>
    </body>
</html>
